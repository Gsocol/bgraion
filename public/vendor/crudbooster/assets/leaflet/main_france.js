...
var categories = {
    101 : {desc: "Mus?©es & Ch??teaux", icon:"museum_archeological.png"},
    103 : {desc: "M?©diath??que", icon:"library.png"},
    ...
    108 : {desc: "Cin?©ma", icon:"cinema.png"}
};
...
$(function() {
    ...
    var options = {
        position: 'topright',
        title: 'Chercher',
        placeholder: 'ex: rez?©, cin?©ma, biblio',
        maxResultLength: 15,
        threshold: 0.5,
