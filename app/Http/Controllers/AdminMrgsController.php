<?php namespace App\Http\Controllers;
	...
	class AdminMrgsController extends \crocodicstudio\crudbooster\controllers\CBController {
       ...
       public function getDetail($id)
       {
           ...
           $name_raion=Raion::find($row->id_raion)->name_full;
...
//           $nom_raion = \Illuminate\Support\Facades\DB::table('raions')->where('name_full',$nazv_raiona)->first()->id;
           ...
           return view('MrgDetail', compact('row', 'page_menu', 'page_title', 'command', 'id','name_raion'));
